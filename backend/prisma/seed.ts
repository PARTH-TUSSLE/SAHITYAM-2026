...
const events = [
  ...
  },
  {
    ...
    rules: [
      ...
      "Prize Distribution: 1st Place - ₹11,000, 2nd Place - ₹5,100, 3rd Place - ₹3,100. Winners will receive cash prizes along with trophies and certificates.",
  ...
  // },
  {
    ...
    prizeAmount: "20,000",
    rules: [
      "The solo traditional dance competition is open to all registered participants of SAHITYAM.",
  ...
  {
    title: "Group Traditional Dance",
    subtitle: "Traditional & Heritage",
    description:
      "Group Traditional dance performance celebrating India's traditional and heritage dance forms. Groups showcase coordination, creativity, and cultural richness through folk, classical, and regional dance styles.",
    image: "/CrewDance.jpeg",
    registrationFee: 1000,
    prizeAmount: "75,000",
    rules: [
      "The group traditional dance competition is open to all registered teams of SAHITYAM.",
  ...
  },
  {
    ...
    subtitle: "Showcase Your Literary Journey",
    description:
      "A platform for emerging authors to present their published works. Participants get an opportunity to share their book's story, inspiration, and journey with an audience of literature enthusiasts and judges.",
    image: "/BestBuddingAuthor.jpg",
    registrationFee: 500,
    prizeAmount: "11,000",
    rules: [
      "The competition is open to all registered participants of SAHITYAM.",
      "This is an individual event - only one participant per registration.",
      "Prize Distribution: 1st Place - ₹5,100, 2nd Place - ₹3,100, 3rd Place - ₹2,100. Winners will receive cash prizes along with trophies and certificates.",
      "There is no age limit for participants.",
      "Participants will get 5–10 minutes to explain their book, including its theme, inspiration, and key messages.",
      "The book must be non-technical in nature.",
      "The participant must be the author of the book being presented.",
      "Content must be original work created by the participant. Plagiarism will lead to disqualification.",
      "Participants are encouraged to bring physical copies of their book for display.",
      "Judging will be based on originality, presentation skills, content quality, and audience engagement.",
      "Content must be decent and appropriate. Obscene or offensive content will lead to disqualification.",
      "The decision of the judges will be final and binding.",
      "Any form of misbehavior or violation of rules will lead to immediate disqualification.",
      "Accommodation Benefits: Participants who have opted for accommodation will receive breakfast, lunch, dinner, a stay, and access to all cultural events of SAHITYAM 2026.",
      "The organizing committee reserves the right to modify the rules and prize pool of all the events if required.",
  ...
  {
    title: "Live Canvas",
    subtitle: "Paint Your Imagination Live",
    description:
      "Create stunning artwork live on canvas within a time limit. Artists compete to showcase their creativity, technique, and artistic vision on a theme revealed on the spot. A true test of spontaneous creativity and artistic excellence.",
    image: "/LiveCanvas.jpg",
    registrationFee: 500,
    prizeAmount: "25,000",
    rules: [
      "The contest is open to all registered participants of SAHITYAM.",
      "This is an individual event - only one participant per canvas.",
      "Prize Distribution: 1st Place - ₹11,000, 2nd Place - ₹5,100, 3rd Place - ₹3,100. Winners will receive cash prizes along with trophies and certificates.",
      "Time limit: 2–3 hours will be provided to complete the artwork.",
      "The theme will be announced on the spot at the event.",
      "Participants must bring their own art materials (canvas, paints, brushes, colors, etc.). Basic materials will not be provided.",
      "Canvas size should be appropriate for the given time frame (recommended: A2 to A1 size).",
      "The artwork must be created live during the event. Pre-drawn or pre-painted work is strictly prohibited.",
      "Any medium can be used (oil, acrylic, watercolor, mixed media, etc.).",
      "Content must be decent, creative, and relevant to the theme. Obscene or offensive content will lead to disqualification.",
      "Judging will be based on creativity, technique, originality, relevance to theme, and overall visual impact.",
      "The decision of the judges will be final and binding.",
      "Any form of misbehavior or violation of rules will lead to immediate disqualification.",
      "Accommodation Benefits: Participants who have opted for accommodation will receive breakfast, lunch, dinner, a stay, and access to all cultural events of SAHITYAM 2026.",
      "The organizing committee reserves the right to modify the rules and prize pool of all the events if required.",
  ...
  },
  {
    ...
    subtitle: "Capture the Essence of SAHITYAM",
    description:
      "Showcase your photography skills by capturing the spirit, emotions, and moments of SAHITYAM. Submit your best shots taken during the event and compete for recognition as the event's top photographer.",
    image: "/PhotographyContest.jpg",
    registrationFee: 500,
    prizeAmount: "25,000",
    rules: [
      "The contest is open to all registered participants of SAHITYAM.",
      ...
      "Prize Distribution: 1st Place - ₹11,000, 2nd Place - ₹5,100, 3rd Place - ₹3,100. Winners will receive cash prizes along with trophies and certificates.",
      "Photographs must be clicked during SAHITYAM 2026 only. Submission of old or external photographs will lead to disqualification.",
      "Participants may use DSLR cameras, mirrorless cameras, or mobile phone cameras.",
      "Each participant may submit up to 3 photographs for judging.",
      "Basic editing (cropping, exposure adjustment, color correction) is allowed.",
      "Heavy manipulation, excessive filters, or major alterations are prohibited.",
      "All submitted photographs must be original work of the participant.",
      "Photographs should capture the essence, emotions, culture, events, or ambiance of SAHITYAM.",
      "Submission deadline and format will be announced during the event.",
      "Content must be decent and appropriate. Obscene or offensive photographs will lead to disqualification.",
      "Judging will be based on creativity, composition, technical quality, relevance to the event, and overall visual impact.",
      "The decision of the judges will be final and binding.",
