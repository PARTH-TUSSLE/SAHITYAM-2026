          ...
          <div className="max-w-3xl mx-auto">
            ...
            <div className="mt-12 text-center">
              ...
              <div className="flex gap-5 justify-center">
                ...
                >
                  <div className="absolute inset-0 bg-gradient-to-br from-pink-500 via-purple-500 to-orange-400 rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                  <svg
