        ...
        <div className="relative bg-white/90 backdrop-blur-xl rounded-3xl shadow-2xl p-8 md:p-10 border border-white/50">
          ...
          <form onSubmit={handleSubmit} className="space-y-6" noValidate>
            ...
            <button
              type="submit"
              disabled={loading}
              className="relative w-full bg-gradient-to-r from-pink-500 to-pink-500 text-white font-bold py-4 rounded-xl shadow-lg shadow-pink-300/50 hover:shadow-xl hover:shadow-pink-400/60 transition-all transform hover:scale-[1.02] disabled:opacity-50 disabled:cursor-not-allowed overflow-hidden group"
            >
