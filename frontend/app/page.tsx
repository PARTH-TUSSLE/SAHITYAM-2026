      ...
      <div className="w-full relative min-h-screen text-gray-800">
        ...
        <div className="relative z-20 py-8 sm:py-12 lg:py-16 px-4 sm:px-6 md:px-12 lg:px-20">
          <div className="max-w-6xl mx-auto relative z-10">
            ...
            <div className="relative isolate flex flex-col items-center gap-4 sm:grid sm:grid-cols-3 sm:gap-6 lg:gap-8 place-items-center overflow-visible mx-auto w-full max-w-[340px] sm:max-w-[560px] md:max-w-[760px] lg:max-w-[860px]">
              {/* Simple decorative accents - CSS only, no heavy DOM elements */}
              <div className="pointer-events-none absolute inset-0 z-0 hidden md:block">
                {/* Simple corner glows */}
                <div className="absolute left-[20%] top-[20%] w-8 h-8 rounded-full bg-purple-400/20 blur-md"></div>
                <div className="absolute right-[20%] top-[20%] w-8 h-8 rounded-full bg-pink-400/20 blur-md"></div>
                <div className="absolute left-[20%] bottom-[20%] w-8 h-8 rounded-full bg-indigo-400/20 blur-md"></div>
                <div className="absolute right-[20%] bottom-[20%] w-8 h-8 rounded-full bg-purple-400/20 blur-md"></div>
              </div>
              ...
              <div className="relative z-20 order-3 sm:order-none w-full sm:w-auto sm:col-span-1">
                ...
                <div className="group relative w-full h-80 sm:w-64 sm:h-64 md:w-80 md:h-80 overflow-hidden rounded-3xl shadow-2xl hover:shadow-3xl transition-all duration-500 hover:scale-[1.03] ring-4 ring-purple-400/60 hover:ring-purple-500">
                  <div className="relative w-full h-full bg-gradient-to-br from-purple-950 via-indigo-950 to-black">
                    <Image
                      src="/AfsanaKhan.jpeg"
                      alt="Afsana Khan - Sufi Night"
                      fill
                      className="object-cover object-top"
                    />
                    <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-black/50 to-transparent"></div>
                    <div className="absolute inset-0 bg-gradient-to-br from-white/10 via-transparent to-transparent opacity-40 transition-opacity duration-500 group-hover:opacity-60"></div>

                    <div className="absolute inset-0 flex flex-col items-center justify-end pb-4 sm:pb-6 md:pb-8 p-4 sm:p-5 md:p-6">
                      <h3 className="text-2xl sm:text-2xl md:text-3xl font-black text-white mb-1 sm:mb-2 text-center drop-shadow-2xl tracking-tight leading-none">
                        Sufi Night
                      </h3>
                      <p className="text-xs sm:text-xs md:text-sm text-gray-200 font-medium text-center drop-shadow-xl mb-2">
                        Mystical Music Evening
                      </p>
                      <p className="text-base sm:text-lg md:text-xl font-black bg-gradient-to-r from-yellow-300 via-amber-300 to-yellow-400 bg-clip-text text-transparent text-center drop-shadow-lg mb-2 sm:mb-3">
                        ⭐ Afsana Khan ⭐
                      </p>
                      <a
                        href="https://www.instagram.com/itsafsanakhan/?hl=en"
                        target="_blank"
                        rel="noopener noreferrer"
                        className="inline-flex items-center gap-1.5 px-3 py-1.5 sm:px-4 sm:py-2 bg-gradient-to-r from-pink-500 via-purple-500 to-indigo-500 text-white text-xs sm:text-sm font-bold rounded-full hover:shadow-lg hover:scale-105 transition-all duration-300"
                      >
