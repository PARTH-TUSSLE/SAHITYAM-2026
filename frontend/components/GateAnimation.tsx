    ...
    >
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center z-10">
        ...
        <motion.div
          ...
          className="h-1 bg-gradient-to-r from-transparent via-purple-400 to-transparent mb-12"
        />
        ...
        >
          <h1 className="text-7xl md:text-8xl font-serif font-bold bg-clip-text text-transparent bg-gradient-to-b from-purple-200 via-pink-100 to-purple-300 drop-shadow-lg">
            Sahityam
          </h1>
          <p className="text-purple-400/70 text-lg tracking-[0.3em] mt-2 font-light">
            LITERARY EXCELLENCE
          </p>
        </motion.div>
        ...
        <motion.div
          ...
          className="text-5xl font-bold text-purple-300/60 mb-8"
        >
          2026
        </motion.div>
        ...
        <motion.div className="flex gap-8 mb-12">
          {[0, 1, 2].map((i) => (
            <motion.div
              ...
              className="w-2 h-2 rounded-full bg-gradient-to-r from-purple-400 to-pink-200"
            />
          ))}
        </motion.div>
        ...
        <div className="absolute w-96 h-96 mt-20">
          <motion.div
            ...
            className="absolute inset-0"
          >
            <div className="absolute bottom-0 right-1/2 transform translate-x-1/2 w-2 h-2 bg-purple-300 rounded-full" />
          </motion.div>
        </div>
        ...
        <motion.div
          ...
          className="absolute w-72 h-72 rounded-full border-2 border-purple-400"
        />
        <motion.div
          initial={{ scale: 0, opacity: 0 }}
          animate={{ scale: 1, opacity: 0.1 }}
          transition={{ duration: 1.8, delay: 0.7 }}
          className="absolute w-96 h-96 rounded-full border border-purple-300"
        />
      </div>
