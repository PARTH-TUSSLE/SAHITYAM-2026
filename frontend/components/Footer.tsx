        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-7 md:gap-8 mb-6 sm:mb-7 md:mb-8">
          ...
          <div className="space-y-3 sm:space-y-4 text-center md:text-left">
            ...
            <p className="text-gray-400 text-xs sm:text-sm leading-relaxed">
              ...
              unforgettable cultural experience on 3rd Feb, 2026.
            </p>
            {/* Social Media Icons */}
            <div className="flex gap-2 sm:gap-3 justify-center md:justify-start">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-8 h-8 sm:w-9 sm:h-9 md:w-10 md:h-10 rounded-full bg-white/10 hover:bg-gradient-to-r hover:from-blue-500 hover:to-blue-600 flex items-center justify-center transition-all duration-300 hover:scale-110 ring-1 ring-white/10"
              >
                <svg
                  className="w-4 h-4 sm:w-4.5 sm:h-4.5 md:w-5 md:h-5"
                  fill="currentColor"
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-8 h-8 sm:w-9 sm:h-9 md:w-10 md:h-10 rounded-full bg-white/10 hover:bg-gradient-to-r hover:from-gray-700 hover:to-black flex items-center justify-center transition-all duration-300 hover:scale-110 ring-1 ring-white/10"
              >
                <svg
                  className="w-4 h-4 sm:w-4.5 sm:h-4.5 md:w-5 md:h-5"
                  fill="currentColor"
          ...
          <div className="space-y-3 sm:space-y-4 text-center">
            ...
            <ul className="space-y-2 sm:space-y-3 flex flex-col items-center">
              <li className="flex items-start gap-3 text-gray-400">
                ...
                <span className="text-xs sm:text-sm">3rd Feb, 2026</span>
              </li>
              <li className="flex items-start gap-3 text-gray-400">
                <svg
                  className="w-5 h-5 text-purple-400 mt-0.5 flex-shrink-0"
