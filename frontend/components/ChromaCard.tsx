      ...
      <div className="relative overflow-hidden rounded-2xl bg-white/80 backdrop-blur-sm shadow-xl transition-all duration-500 hover:shadow-2xl hover:-translate-y-3 border border-gray-200/50">
        ...
        <div className="relative overflow-hidden">
          ...
          <div className="relative h-96 w-full overflow-hidden">
            ...
            <div className="absolute bottom-0 left-0 right-0 px-3 py-6 pb-8">
              {/* Decorative line */}
              ...
              <div className="flex flex-row gap-1 justify-center items-stretch">
                ...
                >
                  <span className="relative z-10 inline-flex items-center gap-1">
                    ...
                    <svg
                      className="w-3 h-3 sm:w-3.5 sm:h-3.5 transition-transform duration-300 group-hover/btn:translate-x-1 flex-shrink-0"
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24"
                    >
                ...
                {isAuthenticated ? (
                  // Show status message if registration is inactive or rejected
                  registrationStatus &&
                  (!registrationStatus.isActive ||
                    ...
                    <button
                      ...
                      disabled={isLoading}
                      className={`relative px-3 py-2.5 font-semibold rounded-lg transition-all duration-300 shadow-lg hover:shadow-xl hover:-translate-y-1 active:scale-95 overflow-hidden group/btn text-xs sm:text-sm flex items-center justify-center ${
                        isRegistered
                      ...
                      <span className="relative z-10 inline-flex items-center gap-1">
                        {isLoading ? (
                          ...
                          <>
                            ...
                            <svg
                              className="w-3 h-3 sm:w-3.5 sm:h-3.5 transition-transform duration-300 group-hover/btn:rotate-12 flex-shrink-0"
                              fill="none"
                              stroke="currentColor"
                              viewBox="0 0 24 24"
                            >
                  ...
                  <button
                    ...
                    className="relative px-3 py-2.5 bg-gradient-to-r from-pink-500 via-purple-600 to-indigo-600 hover:from-pink-600 hover:via-purple-700 hover:to-indigo-700 text-white font-semibold rounded-lg transition-all duration-300 shadow-lg shadow-purple-500/40 hover:shadow-xl hover:shadow-purple-600/50 hover:-translate-y-1 active:scale-95 overflow-hidden group/btn text-xs sm:text-sm ring-1 ring-white/20 flex items-center justify-center"
                  >
                    <span className="relative z-10 inline-flex items-center gap-1">
                      <span className="whitespace-nowrap">
                        Login to Register
